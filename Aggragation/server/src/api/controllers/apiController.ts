...
module.exports = (passport: any) => {
    ...
    publicModule.google_login_ret = (req: any, res: any) => {
    ...
    publicModule.google_login = (req: any, res: any, next: any) => {
        passport.authenticate('local-login', {session: false}, (err: any, user: any, info: any) => {
            if (err) {
                return next(err);
            }
    ...
    publicModule.google_login = (req: any, res: any) => {
    ...
    publicModule.isGoogleValide = (req: any, res: any, next: any) => {
        if (!req.user) {
            return next();
          }
        next();
