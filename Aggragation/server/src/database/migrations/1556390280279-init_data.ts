    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(
            `INSERT INTO public.account(account_id, name, description) VALUES ('server_1', 'compte boitier ferme', 'le compte correspondant au boitier de la ferme');
             INSERT INTO public.partition_config(config_id, start_range, end_range) VALUES ('server_1', 0, 1); 
             INSERT INTO public.device(device_id, name, description,account_id,config_id) VALUES ('server_1', 'Ferme', 'Boitier cleveremote ferme', 'server_1','server_1');
