...
export class initData1556390280279 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(
            `INSERT INTO public.device(device_id, name, description) VALUES ('server_1', 'Ferme', 'Boitier cleveremote ferme');
INSERT INTO public.account(account_id, name, description, device_id) VALUES ('server_1', 'compte boitier ferme', 'le compte correspondant au boitier de la ferme', 'server_1');
