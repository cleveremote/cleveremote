    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(
            `INSERT INTO "Account"("accountId", "name", "description") VALUES ('server_1', 'compte boitier ferme', 'le compte correspondant au boitier de la ferme');
             ...
             INSERT INTO "Scheme"("schemeId", "file", "name", "description", "deviceId") VALUES ('server_1', 'file_name', 'name_name', 'desciption_value', 'server_1');
             INSERT INTO "Sector"("sectorId", "name", "schemeId") VALUES ('server_1', 'name_name','server_1');`
        );
    }
